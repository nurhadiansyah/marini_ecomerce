                      ...
                      <div class="col-sm-12">
                        <select class="form-select" aria-label="Default select example" name="kategori_id" required>
                          ...
                          @foreach( $data as $datas )
                            <option style="text-transform: capitalize" value="{{ $datas->id }}">{{ $datas->nama_kat }}</option>
                          @endforeach
                        </select>
                      </div>
                      </div>
        ...
        <table class="table datatable">
          ...
          <tbody>
            ...
            <tr>
                    ...
                    <div class="col-md-3">
                      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#largeModal{{$barang->id}}">
                         <i class="bi bi-pencil-square"></i></button>
                              {{-- modal edit --}}
                              <div class="modal fade" id="largeModal{{ $barang->id }}" tabindex="-1">
                                <div class="modal-dialog modal-lg">
                                  <div class="modal-content">
                                    <div class="modal-header">
                                      ...
                                      <div class="row">
                                        <form method="POST" action="/barang/{{ $barang->id }}" enctype="multipart/form-data">
                                          ...
                                          <div class="row">
                                            <div class="col-md-12">
                                              <label for="kuantitas" class="form-label">Jumlah Barang</label>
                                              <input name="kuantitas" type="text" class="form-control" id="kuantitas" value="{{ $barang->kuantitas }}">
                                            </div>
                                          </div>
                                          <div class="row">
                                            <div class="col-md-12">
                                              <label for="harga" class="form-label">Harga barang</label>
                                              <input name="harga" type="text" class="form-control" id="harga" value="{{ $barang->harga }}">
                                            </div>
                                          </div>
                                          <div class="row ">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-sm-12">
                                              <select class="form-select" aria-label="Default select example" name="kategori_id" required>
                                                <option selected="selected" class="text-grey" value="{{ $barang->kategori_id }}">{{ $datas->nama_kat }}</option>
                                                @foreach( $data as $datas )
                                                  <option style="text-transform: capitalize" value="{{ $datas->id }}">{{ $datas->nama_kat }}</option>
                                                @endforeach
                                              </select>
                ...
                {{-- tambah barang --}}
                  <div class="col-md-3">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Tambahbarang{{$barang->id}}">
                      <i class="bi bi-plus-square"></i></button>
                           {{-- modal edit --}}
                           <div class="modal fade" id="Tambahbarang{{$barang->id}}" tabindex="-1">
                             <div class="modal-dialog modal-lg">
                               <div class="modal-content">
                                 <div class="modal-header">
                                   <h5 class="modal-title">Large Modal</h5>
                                     ...
                                     <form method="POST" action="/tambahbarang">
                                       ...
                                       <div class="row">
                                         <div class="col-md-12">
                                           ...
                                           <input name="kuantitas" type="text" class="form-control" id="kuantitas">
                                           <input name="id" type="hidden" class="form-control" id="id" value="{{$barang->id}}">
                                         </div>
                                       </div>
                                       <br>
                                        <div class="text-center">
