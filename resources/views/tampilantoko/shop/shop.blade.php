        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <ul class="list-unstyled templatemo-accordion">
                    <li class="pb-3">
                        <a class="font-weight-bold collapsed d-flex justify-content-between h2 text-bld text-decoration-none" href="#">
                            Kategori
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid-custom" src="{{ asset('storage/' . $barang->gambar) }}">
